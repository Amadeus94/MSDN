...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTypeAccess().getTypeNameAlternatives_0(), "rule__Type__TypeNameAlternatives_0");
			...
			builder.put(grammarAccess.getMathExpAccess().getFunctionsAssignment_3(), "rule__MathExp__FunctionsAssignment_3");
			...
			builder.put(grammarAccess.getFunctionAccess().getArgumentAssignment_3(), "rule__Function__ArgumentAssignment_3");
			builder.put(grammarAccess.getArgumentAccess().getTypeAssignment(), "rule__Argument__TypeAssignment");
			builder.put(grammarAccess.getTypeAccess().getTypeNameAssignment(), "rule__Type__TypeNameAssignment");
		}
	}
