 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.MathExpImpl#getFunctions <em>Functions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MathExpImpl extends MinimalEObjectImpl.Container implements MathExp
{
  ...
  public EList<Function> getFunctions()
  {
    if (functions == null)
    {
      functions = new EObjectContainmentEList<Function>(Function.class, this, MathPackage.MATH_EXP__FUNCTIONS);
    }
    return functions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MathPackage.MATH_EXP__FUNCTIONS:
