...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass paranthesisEClass = null;
   ...
   */
  @Override
  public EReference getMathExp_Functions()
  {
   ...
   */
  @Override
  public EClass getParanthesis()
  {
    return paranthesisEClass;
  }
   ...
   */
  @Override
  public EReference getParanthesis_Exp()
  {
    return (EReference)paranthesisEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(mathExpEClass, MATH_EXP__FUNCTIONS);
    ...
    paranthesisEClass = createEClass(PARANTHESIS);
    createEReference(paranthesisEClass, PARANTHESIS__EXP);
  }
  ...
  public void initializePackageContents()
  {
    ...
    paranthesisEClass.getESuperTypes().add(this.getExpression());
    ...
    initEReference(getMathExp_Functions(), this.getFunction(), null, "functions", null, 0, -1, MathExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(paranthesisEClass, Paranthesis.class, "Paranthesis", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getParanthesis_Exp(), this.getExpression(), null, "exp", null, 0, 1, Paranthesis.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
